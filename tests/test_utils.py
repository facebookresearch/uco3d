...
from uco3d.dataset_utils.uco3d_types import (
    UCO3DCameras,
    PointCloud,
    opencv_image_undistorter,
)
...
class TestDataloader(unittest.TestCase):
    def test_frame_data_to(
        ...
        rand_frame_data = UCO3DFrameData(
            ...
            camera_quality_score=torch.tensor([0.0]),
            point_cloud_quality_score=torch.tensor([0.0]),
        ...
        for device_str in ("cpu", "cuda:0"):
            ...
            def _test_on_device(frame_data_on_device):
                for field in dataclasses.fields(frame_data_on_device):
                    ...
                    elif isinstance(value, UCO3DCameras):
